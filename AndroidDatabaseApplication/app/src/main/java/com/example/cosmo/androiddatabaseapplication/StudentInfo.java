...
public class StudentInfo {
    ...
    public long createEntry(String name, String program, String level){
    ...
    public String getLevel(Long l){
        String[] columns = new String[]{KEY_ROWID,KEY_NAME,KEY_PROGRAM,KEY_LEVEL};
        Cursor c = ourDatabase.query(DATABASE_TABLE, columns, KEY_ROWID + "=" + l, null, null, null, null);
        if(c !=null){
            c.moveToFirst();
            String program = c.getString(3);
            return program;
        }
        return null;
    }

    public void updateEntry(Long lrow, String sname, String sprogram, String slevel){
